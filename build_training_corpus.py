...
def build_corpus(target_dir, corpus_save_path, offset=0):
...
def main():
    ...
    build_corpus(target_dir=target_dir, corpus_save_path=corpus_path, offset=380000)
